...
public class CustomGameInstanceSample extends GameInstance {
    ...
    public CustomGameInstanceSample(JavaPlugin plugin, GamesManager gamesManager, InstanceSettings settings, Location instanceLocation, List<MmcTeam> mmcTeams, int instanceId) {
